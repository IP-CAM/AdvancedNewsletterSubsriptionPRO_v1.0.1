<table class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td class="text-center">Data de inscrição</td>
        ...
        <tr>
            ...
            <td class="text-center">
                <select name="status[<?php echo $email['id']?>][]" id="">
                    <option value="0" <?php echo ($email['status_ori'] == '0' ? 'selected="selected"' : '')?>>Desabilitado</option>
                    <option value="1" <?php echo ($email['status_ori'] == '1' ? 'selected="selected"' : '')?>>Habilitado</option>
                    <option value="2" <?php echo ($email['status_ori'] == '2' ? 'selected="selected"' : '')?>>Blacklist</option>
                    <option value="3" <?php echo ($email['status_ori'] == '3' ? 'selected="selected"' : '')?>>Não inscrito</option>
                    <option value="4" <?php echo ($email['status_ori'] == '4' ? 'selected="selected"' : '')?>>Não verificado</option>
                </select>
            </td>
        </tr>
        <?php } ?>
