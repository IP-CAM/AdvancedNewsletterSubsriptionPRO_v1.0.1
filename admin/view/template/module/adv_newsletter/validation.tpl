                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-validation" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <a href="javascript:void(2)" class="btn btn-default skip-validate"><i class="fa fa-history"></i> Pular</a> 
                            <i style="color:#ccc">Você pode pular esse passo, mas será necessário validar seu site no futuro!</i>
                        </div>
                    </div>
                </form>
            </div>
