<?php echo $header; ?><?php echo $column_left; ?>
    ...
    <div class="container-fluid">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-adv_newsletter" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Enviar boletim para o status</label>
                                <div class="col-sm-10">
                            ...
                            <div class="clearfix"></div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Mostrar no frontend como</label>
                                <div class="col-sm-10">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-newspaper-o"></i>Email Inscrito</h3>
            </div>
